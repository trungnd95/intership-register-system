    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        <a href="{{route('admin.companies.index')}}">
          <i class="fa fa-building"></i><span>Doanh nghiệp</span>
        </a>
        {{-- <ul class="treeview-menu">
      ...
      <li ><a href="{{route('admin.status.index')}}"><i class="fa fa-bell"></i><span>Tình trạng đăng kí</span></a></li>

      <li class="treeview">
        <a href="{{route('admin.notification.index')}}">
          <i class="fa fa-building"></i><span>Thông báo</span>
        </a>
        {{-- <ul class="treeview-menu">
          <li><a href="{{route('admin.companies.index')}}"><i class="fa fa-list"></i>Danh sách doanh nghiệp</a></li>
          <li><a href="#"><i class="fa fa-plus-circle"></i>Thêm tin</a></li>
